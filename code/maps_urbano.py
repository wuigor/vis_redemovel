...
vetor = [d_2G_urbano, d_3G_urbano, d_4G_urbano]
vetorNomes = ["2G Urbano", "3G Urbano", "4G Urbano"]
...
plotly.io.write_html(fig, file="urbano.html", full_html=False, default_height="80%")